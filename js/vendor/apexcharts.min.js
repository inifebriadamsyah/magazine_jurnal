...
!function (t, e) {
    ...
    var y, w, k = {
        ...
        return a(t, [{
            ...
            key: "addImage", value: function (t, e, i) {
                var a = t.path, s = t.x, r = void 0 === s ? 0 : s, n = t.y, o = void 0 === n ? 0 : n, l = t.width,
                    h = void 0 === l ? 20 : l, c = t.height, d = void 0 === c ? 20 : c, g = t.appendTo,
                    u = void 0 === g ? i.w.globals.dom.Paper.node : g, f = i, p = f.w,
        ...
        return a(t, [{
            ...
            key: "resetSeries", value: function () {
                var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                    e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], i = this.w,
        ...
        return a(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    c = n.config.xaxis.labels.formatter, d = !1, g = new R(this.ctx), u = o;
        ...
        return a(t, [{
            key: "fixSvgStringForIe11", value: function (t) {
                ...
                var e = 0, i = t.replace(/xmlns="index.html\/\/www.w3.org\/2000\/svg"/g, (function (t) {
            ...
            key: "exportToCSV", value: function (t) {
                var e = this, i = t.series, a = t.columnDelimiter, s = void 0 === a ? "," : a, r = t.lineDelimiter,
                    ...
                    d = new D(this.ctx), g = new H(this.ctx), u = function (t) {
                        var i = "";
        ...
        return a(t, [{
            key: "drawYaxis", value: function (t) {
                var e = this.w, i = new p(this.ctx), a = e.config.yaxis[t].labels.style, s = a.fontSize,
                    r = a.fontFamily, n = i.group({
                ...
                n.add(o);
                var l = e.globals.yAxisScale[t].result.length - 1, h = e.globals.gridHeight / l,
                    c = e.globals.translateY, d = e.globals.yLabelFormatters[t],
                    g = e.globals.yAxisScale[t].result.slice();
                g = this.axesUtils.checkForReversedLabels(t, g);
                var u = "";
                if (e.config.yaxis[t].labels.show) for (var f = function (n) {
                    var f = g[n];
                    f = d(f, n);
                    ...
                    if (n === l && (u = x), o.add(x), 0 !== e.config.yaxis[t].labels.rotate) {
                        var b = i.rotateAroundCenter(u.node), m = i.rotateAroundCenter(x.node);
                ...
                var y = e.config.yaxis[t].axisBorder, w = 31 + y.offsetX;
        ...
        return a(t, [{
            key: "drawAxis", value: function (t, e) {
                var i, a, s = this.w.globals, r = this.w.config, n = new O(this.ctx), o = new G(this.ctx);
            ...
            key: "checkResponsiveConfig", value: function (t) {
                ...
                if (0 !== a.responsive.length) {
                    ...
                    var r = new P({}), n = function () {
                        ...
                        } else for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = I.extendArrayProps(r, s[l].options), t = g.extend(i.config, t), e.overrideResponsiveOptions(t))
                    };
                    if (t) {
        ...
        return a(t, [{
            key: "getxAxisLabelsCoords", value: function () {
                ...
                if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
                    ...
                    var s = e.globals.xLabelFormatter, r = g.getLargestStringFromArr(i),
                    ...
                    var o = new R(this.dCtx.ctx), l = r;
                    r = o.xLabelFormat(s, r, l), n = o.xLabelFormat(s, n, l), e.config.xaxis.convertedCatToNumeric && void 0 === r && (n = r = "1");
                    var h = new p(this.dCtx.ctx), c = h.getTextRects(r, e.config.xaxis.labels.style.fontSize), d = c;
            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return e.config.yaxis.map((function (s, r) {
                    if (s.show && s.labels.show && e.globals.yAxisScale[r].result.length) {
                        ...
                        var c = new p(t.dCtx.ctx), d = c.getTextRects(o, s.labels.style.fontSize), u = d;
        ...
        return a(t, [{
            ...
            key: "animateArc", value: function (t, e, i, a, s, r) {
                ...
                l.globals.dataChanged && r.shouldSetPrevPaths && r.prevEndAngle && (n = o.getPiePath({
                    ...
                    "pie" !== l.config.chart.type && "donut" !== l.config.chart.type || this.animate(l.config.chart.animations.dynamicAnimation.speed).attr({"stroke-width": o.strokeWidth}), r.i === l.config.series.length - 1 && h.animationCompleted(t)
                })).during((function (l) {
        ...
        return a(t, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new p(this.ctx), s = new I(this.ctx, i);
        ...
        return o(i, t), a(i, [{
            key: "draw", value: function (t, e) {
                ...
                for (var o = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), l = 0, h = 0, c = function (s, r) {
                    var c = void 0, d = void 0, u = void 0, f = void 0, p = [], x = [],
                    ...
                    var m = i.graphics.group({
                            ...
                            rel: s + 1,
                            "data:realIndex": b
                        }), v = i.graphics.group({class: "apexcharts-datalabels", "data:realIndex": b}), y = 0, w = 0,
            ...
            key: "drawStackedColumnPaths", value: function (t) {
                ...
                var S = {barWidth: r, strokeWidth: o, yRatio: this.yRatio[this.yaxisIndex], barXPosition: x, y: a},
                ...
                var L = this.graphics.move(x, p), P = this.graphics.move(x, p);
                ...
                return i += s, {pathTo: L, pathFrom: P, x: h.globals.isXNumeric ? i - s : i, y: a}
            }
        }]), i
    }(bt), vt = function (t) {
        function i() {
        ...
        return a(t, [{
            key: "draw", value: function (t) {
                ...
                if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, o) {
                    ...
                    d = e.graphics.group({class: "apexcharts-series-markers-wrap apexcharts-element-hidden"}), f = e.graphics.group({
                        class: "apexcharts-datalabels",
                        "data:realIndex": o
            ...
            key: "draw", value: function (t, e) {
                ...
                for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                    ...
                    for (var y = a.group({
                        ...
                        d = C.y, c = C.x;
                        var I = this.barHelpers.getPathFillColor(t, r, w, f), M = i.globals.stroke.colors[f];
                        this.renderSeries({
                            realIndex: f,
                            pathFill: I,
                            lineFill: M,
        ...
        return a(t, [{
            ...
            key: "_initSerieVariables", value: function (t, e, i) {
                ...
                }), this.elPointsMain = s.group({class: "apexcharts-series-markers-wrap"}), this.elDataLabelsWrap = s.group({
                    class: "apexcharts-datalabels",
                    "data:realIndex": i
                });
                ...
                case"A":
                    t = (e = function (t, e) {
                        var i, a, s, r, n, o, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P,
                            T = Math.abs(e[1]), z = Math.abs(e[2]), I = e[3] % 360, M = e[4], X = e[5], E = e[6],
                            Y = e[7], F = new SVG.Point(t), D = new SVG.Point(E, Y), R = [];
        ...
        return a(t, [{
            ...
            key: "mount", value: function () {
                ...
                return new Promise((function (s, r) {
                    ...
                    var o = new O(t.ctx), l = new G(t.ctx);
